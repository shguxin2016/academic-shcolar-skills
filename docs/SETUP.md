...
export OPENAI_API_KEY="<your-openai-api-key>"   # For GPT-5.4 Pro
...
```bash
git clone https://github.com/crazymsn/academic-shcolar-skills.git ~/academic-shcolar-skills
...
1. Go to <https://github.com/crazymsn/academic-shcolar-skills>
...
3. Import from GitHub: in the Project, click **Files** → **+** → **GitHub** → select `crazymsn/academic-shcolar-skills`.
