...
> 二次分發鏡像：本倉庫保留上游署名和授權條款。繼續使用前請先閱讀
...
原上游專案包含一次完整 10 階段 pipeline 的 PDF 展示產物。本鏡像為了保持倉庫輕量，
並降低第三方內容二次分發的審核風險，沒有重新分發這些二進位 PDF。

保留的產物清單見 [examples/showcase/README.md](examples/showcase/README.md)；如果需要原始展示檔案，
請查看上游倉庫。
